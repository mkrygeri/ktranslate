...
var (
	...
	InputTestingUnify = []*JCHF{
		&JCHF{CompanyId: 10, DeviceName: "router1", SrcAddr: "10.2.2.1", Protocol: "TCP", DstAddr: "2001:db8::68", Timestamp: 1, L4DstPort: 80, L4SrcPort: 34566, SrcAs: 1111, SrcGeo: "US", InputPort: IfaceID(10), OutputPort: IfaceID(20), EventType: KENTIK_EVENT_TYPE, CustomStr: map[string]string{"foo": "bar"}, CustomInt: map[string]int32{"fooI": 1}, CustomBigInt: map[string]int64{"fooII": 12}, InBytes: 12121, InPkts: 12, OutBytes: 13, OutPkts: 1, SrcEthMac: "90:61:ae:fb:c2:19", avroSet: map[string]interface{}{}},
		&JCHF{CompanyId: 10, DeviceName: "router1", Protocol: "TCP", DstAddr: "10.2.2.1", SrcAddr: "2001:db8::68", Timestamp: 1, L4SrcPort: 80, L4DstPort: 34566, SrcAs: 1111, SrcGeo: "US", InputPort: IfaceID(20), OutputPort: IfaceID(10), EventType: KENTIK_EVENT_TYPE, CustomStr: map[string]string{"foo": "bar"}, CustomInt: map[string]int32{"fooI": 1}, CustomBigInt: map[string]int64{"fooII": 12}, InBytes: 12121, InPkts: 12, OutBytes: 13, OutPkts: 1, SrcEthMac: "90:61:ae:fb:c2:19", avroSet: map[string]interface{}{}},
	}
)
